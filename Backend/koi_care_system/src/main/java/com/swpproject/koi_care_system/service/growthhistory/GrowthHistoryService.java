...
public class GrowthHistoryService implements IGrowthHistoryService {
    ...
    public GrowthHistoryDto createGrowthHistory(GrowthCreateRequest growthCreateRequest) throws IOException {
        ...
        if (savedGrowthHistory.getId() == latestId) {
            String imageUrl = (savedGrowthHistory.getImageUrl().equals("https://koicareimage.blob.core.windows.net/koicarestorage/defaultGrowthHistory.png")?
    ...
    public GrowthHistoryDto updateGrowthHistory(Long id, GrowthUpdateRequest growthUpdateRequest) {
        ...
        updateKoiFish(growthHistoryLatest,(growthHistoryLatest.getImageUrl().equals("https://koicareimage.blob.core.windows.net/koicarestorage/defaultGrowthHistory.png")? koiFish.getImageUrl() : growthHistoryLatest.getImageUrl()));
        koiFishRepository.save(koiFish);
