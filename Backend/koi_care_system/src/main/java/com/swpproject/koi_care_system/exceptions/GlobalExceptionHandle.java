...
public class GlobalExceptionHandle {
    ...
    ResponseEntity<ApiResponse> handlingAlreadyExistsException(AlreadyExistsException exception) {
        ApiResponse apiResponse = new ApiResponse();
        apiResponse.setMessage(exception.getMessage());
        return ResponseEntity.status(409).body(apiResponse); // 409 Conflict
    }
