  ...
  const updateProduct = async (data) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://koicaresystem.azurewebsites.net/api/products/product/${id}/update`,
        {
          name: data.name, 
          brand: data.brand,
          price: data.price,
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className='mb-4'>
              ...
              <div className='mb-4'>
                ...
                >
                  <option value={products.supplier ? products.supplier.name : ''}>{products.supplier ? products.supplier.name : ''}</option>
