...
function UserDetail() {
  ...
  const getPayment = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/api/payment/user/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const getOrder = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/api/orders/user/${id}/order`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
