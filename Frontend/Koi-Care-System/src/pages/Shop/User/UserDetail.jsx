...
function UserDetail() {
  ...
  const getPayment = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apipayment/user/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const getOrder = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apiorders/user/${id}/order`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
