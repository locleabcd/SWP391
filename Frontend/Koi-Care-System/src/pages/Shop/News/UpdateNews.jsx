...
function UpdateNews() {
  ...
  const fetchBlog = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv4.azurewebsites.net/api/blog/getID/${id}`, {
        headers: {
  ...
  const updateBlog = async (data) => {
    ...
    try {
      ...
      const res = await axios.put(`https://koicaresystemv4.azurewebsites.net/api/blog/update/${id}`, formData, {
        headers: {
