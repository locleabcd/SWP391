...
function UpdateNews() {
  ...
  const fetchBlog = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apiblog/getID/${id}`, {
        headers: {
  ...
  const updateBlog = async (data) => {
    ...
    try {
      ...
      const res = await axios.put(`https://koicaresystemv2.azurewebsites.net/apiblog/update/${id}`, formData, {
        headers: {
