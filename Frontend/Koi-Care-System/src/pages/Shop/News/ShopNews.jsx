              ...
              <table className='min-w-full  border-spacing-x-1 border-gray-200'>
                <thead className='border-gray-200'>
                  <tr className='border-b'>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>ID</th>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>Image</th>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>Title</th>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>Content</th>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>Tags</th>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>Date</th>
                    <th className='py-3 px-5 text-left text-xs font-bold uppercase'>Action</th>
                  </tr>
                </thead>
                <tbody>
                  {blogs.map((blog) => (
                    <tr key={blog.blogId}>
                      ...
                      <td className='py-2 px-3 border-b border-gray-200'>
                        <img src={blog.blogImage} alt='Blog' className='w-40 h-20 object-cover rounded-md' />
                      </td>
                      <td className='py-2 px-3 border-b border-gray-200'>{blog.blogTitle}</td>
                      <td className='py-2 px-3 border-b border-gray-200'>{blog.blogContent.substring(0, 70)}...</td>
                      <td className='py-2 px-3 border-b border-gray-200'>
                        {blog.tags?.map((tag) => (
                          <span
                            key={tag.tagId}
                      ...
                      <td className='py-2 px-3 border-b border-gray-200'>
                        <div className='flex justify-center items-center'>
                          <Link
                            to={`/shop/shopNews/update/${blog.blogId}`}
