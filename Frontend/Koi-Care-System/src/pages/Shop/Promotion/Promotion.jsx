                    ...
                    <tr key={promotion.id}>
                      ...
                      <td className='py-2 px-1 text-center border-b  border-gray-200'>
                        <div className='flex justify-center items-center'>
                          <Link to={`/shop/promotion/${promotion.id}`} className='p-1 hover:bg-green-500 text-green-500 hover:text-white rounded-full'>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                              fill="currentColor"
                          ...
                          <button className='p-1 hover:bg-red-500 text-red-600 hover:text-white rounded-full' onClick={() => deletePromotion(promotion.id)}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                              fill="currentColor"
