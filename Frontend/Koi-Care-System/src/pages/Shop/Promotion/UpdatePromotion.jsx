...
function UpdatePromotion() {
  ...
  const fetchPromotion = async () => {
    ...
    try {
      ...
      setPromotions(res.data.data); // Giả sử bạn đã khai báo setPromotion ở trên
    } catch (error) {
  ...
  // This effect will reset the form with the fetched promotion data
  useEffect(() => {
    if (promotions) {
      reset({
  ...
  }, [promotions, reset]); // Run when promotions or reset changes
