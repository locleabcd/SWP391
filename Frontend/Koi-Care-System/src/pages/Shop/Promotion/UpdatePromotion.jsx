...
function UpdatePromotion() {
  ...
  const fetchProductDetails = async (id) => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apipromotions/${id}/products/view`, {
  ...
  const fetchPromotion = async () => {
    ...
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apipromotions/promotion/${id}`, {
        headers: {
  ...
  const updatePromotions = async (data) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://koicaresystemv2.azurewebsites.net/apipromotions/promotion/${id}/update`,
        {
          id: id,
          name: data.name,
