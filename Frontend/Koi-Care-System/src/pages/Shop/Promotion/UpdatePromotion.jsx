...
function UpdatePromotion() {
  ...
  const fetchProductDetails = async (id) => {
    try {
      ...
      const res = await axios.get(`http://146.190.84.154:8080/api/promotions/${id}/products/view`, {
  ...
  const fetchPromotion = async () => {
    ...
    try {
      ...
      const res = await axios.get(`http://146.190.84.154:8080/api/promotions/promotion/${id}`, {
        headers: {
  ...
  const updatePromotions = async (data) => {
    ...
    try {
      ...
      const res = await axios.put(
        `http://146.190.84.154:8080/api/promotions/promotion/${id}/update`,
        {
          id: id,
          name: data.name,
