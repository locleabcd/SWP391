...
function Dashboard() {
  ...
  const columnsProduct = [
      ...
      renderCell: (params) => (
        <div className='relative w-full mt-6'>
          <div 
            ...
            style={{ width: `${params.row.percent}%` }}
          />
    ...
    { field: 'totalPrice', headerName: 'Total Price', width: 100, renderCell: (params) => formatCurrency(params.row.totalPrice)}
  ]
  ...
  const columnsOrder = [
    ...
    { field: 'totalPrice', headerName: 'Total Price', width: 100, renderCell: (params) => formatCurrency(params.row.totalAmount)}
  ]
            ...
            <div className='col-span-5 flex flex-col  mt-6 border rounded-md'>
              ...
              <ResponsiveContainer className={`p-6`} width="100%" height={400}>
                <AreaChart data={chartData}>
                  ...
                  <Legend />
                  <Area type="monotone" dataKey="paymentAmount" stroke="#8884d8"  fillOpacity={1} fill="url(#colorUv)" name="Payments" />
                  <Area type="monotone" dataKey="orderAmount" stroke="#82ca9d" fillOpacity={1} fill="url(#colorPv)" name="Orders" />
                </AreaChart>
              </ResponsiveContainer>             
            </div>
            ...
            <div className='flex flex-col  mt-6 border rounded-md'>
              ...
              <ResponsiveContainer className={`p-2`} width="100%" height={450}>
                <BarChart data={usersData} >
                  ...
                  />
                  <Bar 
                    dataKey="usersPremium" 
                    fill="#82ca9d" 
                    name="Premium Users"
                    animationKey="usersPremium" 
                  />
                </BarChart>
              </ResponsiveContainer>
            </div> 
