  ...
  return (
    <div className="h-screen flex flex-col sm:flex-row">
      ...
      >
        ...
        <div className="py-5 px-4 sm:px-[30px] mx-auto max-w-full sm:max-w-[1750px]">
          <TopLayout text="Product" textName="View Product" links="admin/product" />

          <div className="flex flex-col sm:flex-row border border-gray-200 px-4 py-5 sm:px-7 sm:py-5 min-h-[700px] rounded-xl">
            <div className="flex-none w-full sm:w-[600px] mb-4 sm:mb-0">
              <div id="controls-carousel" className="relative w-full" data-carousel="static">
                <div className="relative h-[650px] duration-500 transition-all overflow-hidden rounded-xl border border-gray-200">
                  {images.map((image, index) => (
                    ...
                    >
                      <img src={image.downloadUrl} className="absolute block w-full h-full" alt={`Image ${index + 1}`} />
                    </div>
                  ))}
                </div>
                ...
                <div className="flex mt-4 gap-2 justify-start">
                  {images.map((image, index) => (
                    <button
                      ...
                      className={`w-24 sm:w-32 h-24 sm:h-32 border rounded-md overflow-hidden focus:outline-none ${
                        currentIndex === index ? 'border-blue-500' : 'border-gray-300'
                      }`}
                    >
                      <img src={image.downloadUrl} className="w-full h-full object-cover" alt={`Thumbnail ${index + 1}`} />
                    </button>
                  ))}
                </div>
            ...
            <div className="flex-auto sm:px-10 py-8">
              <div className="border-b border-gray-200 pb-8">
                ...
                <div className="text-2xl sm:text-3xl font-semibold mt-5">{productId.name}</div>
                <div className="text-lg sm:text-xl text-justify mt-5">{productId.description}</div>
                <div className="text-2xl sm:text-3xl mt-5 font-semibold">${productId.price}</div>
                ...
                <div className="flex mt-5 gap-3 items-center">
                  ...
                  <div className="text-base sm:text-xl text-blue-300">({feedback.length} reviews)</div>
                </div>
              </div>

              <div className="flex flex-col sm:flex-row mt-5 gap-5 items-center border-b border-gray-200 pb-10 pt-5">
                <div className="text-2xl sm:text-3xl font-semibold">Quantity:</div>
              ...
              <div className="flex flex-col sm:flex-row mt-5 gap-5 items-center border-b border-gray-200 pb-10 pt-5">
                <button className="text-lg sm:text-xl py-4 px-10 bg-blue-400 hover:bg-blue-500 text-white rounded-lg">
                  Buy Now
                </button>
                <button
                  onClick={() => handleAddToCart(productId)}
                  className="text-lg sm:text-xl py-4 px-10 bg-orange-500 hover:bg-orange-600 text-white rounded-lg"
                >
                  Add to cart
                </button>
              </div>
          ...
          <div className="mt-10 sm:mt-20 border border-gray-200 rounded-xl px-4 sm:px-10 py-5">
            <div className="text-2xl sm:text-3xl">Post Reviews</div>
          ...
          <div className="mt-10 sm:mt-20 border rounded-xl border-gray-200 px-4 sm:px-10 py-5">
            <div className="flex gap-2">
              <div
                className={`text-lg sm:text-xl py-3 px-4 border-b cursor-pointer ease-in duration-200 ${
              ...
              <div
                className={`text-lg sm:text-xl py-3 px-4 border-b cursor-pointer ${
            ...
            <div className="py-3">
              {active === 'description' && (
                <div className="">
                  <div className="text-xl sm:text-2xl font-semibold text-justify leading-7 indent-7 py-5">
                    {productId.description}
                  </div>
                  <div className="text-base sm:text-lg text-justify indent-7 py-2">{productId.description_detail}</div>
                </div>
              )}
              {active === 'reviews' && (
                <div className="flex flex-col sm:flex-row gap-10">
                  <div className="flex-none w-full sm:w-[400px] max-h-[280px] border border-gray-200 flex flex-col items-center justify-center py-20">
                    <div className="text-2xl font-semibold">Average Rating</div>
                    <div className="mt-3 text-2xl sm:text-3xl text-blue-400">{productId.rating.toFixed(1)}/5</div>
                  ...
                  <div className="flex-auto flex flex-col border max-h-[280px] gap-10 overflow-y-auto border-gray-200 px-8 py-10">
                    ...
                    {feedback.map((feedbacks) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col justify-center items-center" onClick={() => toggleHide(feedbacks.id)}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                          ...
                          >
                            ...
                            <button className="py-2 px-4 hover:bg-gray-200" onClick={() => deleteFeedback(feedbacks.id)}>
                              Remove
                            </button>
                          </div>
                        </div>
          ...
          <div className="mt-10 sm:mt-20">
            <div className="text-2xl sm:text-3xl font-semibold">Related Products</div>
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 py-3 mt-4">
                {productRelate.length > 0 ? (
                  productRelate.map((products) => (
                    <div
                      key={products.id}
                      className="border border-gray-200 rounded-xl hover:scale-105 duration-300"
                    >
                      <div>
                      ...
                      <div className="px-7 py-5 text-lg sm:text-xl mt-5 font-medium">
