...
function UpdateSupplierAD() {
  ...
  const fetchSupplier = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/api/suppliers/supplier/${id}/by_id`, {
        headers: {
  ...
  const updateSupplier = async (data) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://koicaresystemv2.azurewebsites.net/api/suppliers/supplier/${id}/update`,
        {
          name: data.name,
          phone: data.phone,
...
export default UpdateSupplierAD
