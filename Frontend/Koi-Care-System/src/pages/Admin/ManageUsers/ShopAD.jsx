...
function ShopAD() {
  ...
  const getUsers = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv4.azurewebsites.net/api/users`, {
        headers: {
  ...
  const handleCreateStaff = async () => {
    ...
    try {
      ...
      const res = await axios.post(`https://koicaresystemv4.azurewebsites.net/api/users/register/staff`, requestBody, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
