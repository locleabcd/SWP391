            ...
            <table className='min-w-full border-spacing-x-1 border-gray-200'>
              <thead>
                <tr className='border-b'>
                  ...
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Name</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Email</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Phone</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Address</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Create Date</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Date of birth</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Bio</th>
                  <th className='py-3 px-2 text-center text-xs font-bold uppercase'>Role</th>
              ...
              <tbody>
                {users.map((user, index) => (
                  <tr key={user.id}>
                    ...
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.name}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.email}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.phone}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.address}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.createdDate}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.dateOfBirth}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.bio}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.role}</td>
                    <td className='py-2 px-2 text-center border-b border-gray-200'>{user.status}</td>
