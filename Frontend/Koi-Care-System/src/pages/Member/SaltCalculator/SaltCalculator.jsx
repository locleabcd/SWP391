        ...
        <div className='grid grid-cols-4 p-4 text-lg'>
          ...
          <div className="p-4">
            <label>Phần trăm thay đổi nước (%): 
              ...
              />
              <span className="ml-2">{waterChangePercent}%</span>
            </label>
          </div>
          
          </div>
            <div className='col-span-2 text-white justify-center pl-8 py-20 bg-gradient-to-l from-pink-300 to-red-300 border-solid rounded-lg shadow-2xl'>
          ...
          {saltNeeded >= 0 && (
            ...
            <div className='footer w-2/4  bg-slate-600 text-white border-solid rounded-lg mx-auto py-5 text-xl text-center '>
              ...
              <label><strong>Lượng muối cần thêm:</strong></label>
                  <label>{saltNeeded.toFixed(2)} grams</label>
                  </div>
                  <div className='row space-x-60'>
                  <label><strong>Lượng nước cần thay:</strong></label>
