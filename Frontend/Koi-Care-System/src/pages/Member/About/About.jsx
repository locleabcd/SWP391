      ...
      >
        ...
        <div className='py-5 px-[30px] mx-auto'>
          ...
          <div className='mt-12 rounded-lg p-6 shadow-xl border'>
            <p className='font-dancing mb-6'>
              Thank you for using our websites.
            </p>

            <p className='font-dancing'>
              Having kept and loved koi fish for several years, We came up with the idea of developing an app for koi owners to make fish keeping easier.
              Our goal is to keep the app up-to-date and to provide assistance for every koi owner.
            </p>
            <p className='mb-6 font-dancing'>
            Our goal is to keep the app up-to-date and to provide assistance for every koi owner.
            A rating in the App Store or sharing the app would therefore make us very happy and motivate us to continue developing additional features.
            </p>
            <p className='mb-6 font-dancing '>
              If you have any questions or suggestions for improvement, please send an e-mail to <a href='#' className='text-blue-500 underline'>feedback@koicaresystem.com</a>.
            </p>
            <p className='text-red-500 font-dancing'>
              The Koi Care Team
