...
function KoiDetails() {
  ...
  const getGrowthHistory = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apigrowth-history/list/${id}`, {
        headers: {
  ...
  const getRemark = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apiremark/get-all/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const upDateRemark = async (data, id = null) => {
    ...
    try {
      ...
      if (id) {
        await axios.put(
          `https://koicaresystemv2.azurewebsites.net/apiremark/update/${id}`,
          {
            title: data.title,
        ...
        await axios.post('https://koicaresystemv2.azurewebsites.net/apiremark/create', jsonData, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        })
  ...
  const upDateGrowth = async (data, id = null) => {
    ...
    try {
      ...
      if (id) {
        ...
        await axios.put(`https://koicaresystemv2.azurewebsites.net/apigrowth-history/update/${id}`, formData, {
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        await axios.post('https://koicaresystemv2.azurewebsites.net/apigrowth-history/create', formData, {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'multipart/form-data'
          }
  ...
  const getKoi = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apikoifishs/koifish/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const deleteGrowth = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://koicaresystemv2.azurewebsites.net/apigrowth-history/delete/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const deleteRemark = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://koicaresystemv2.azurewebsites.net/apiremark/delete/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const updateKoi = async (data, id) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://koicaresystemv2.azurewebsites.net/apikoifishs/koifish/${id}/update`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',
  ...
  const deleteKoi = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://koicaresystemv2.azurewebsites.net/apikoifishs/koifish/${id}/delete`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
