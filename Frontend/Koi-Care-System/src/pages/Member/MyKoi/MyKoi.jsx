        ...
        >
          <Header />
            ...
            <div className='fixed w-[145px] h-14 bottom-6 right-5 rounded-3xl bg-red-500'>
              <p className='text-3xl font-semibold pt-2 pl-3'>{koiCounts[localStorage.getItem('id')] !== undefined ? koiCounts[localStorage.getItem('id')] : '...'} Koi</p>
            </div> 
                  
          <div className="p-2 w-full ">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 py-3">
              {kois.map((koi) => (
                <div key={koi.id} className={`${
                  ...
                  <div className='flex gap-3 '>                   
                      ...
                      <div className=' w-[55%] flex mt-1  '>  
                        ...
                        <div className='grid grid-rows-4'>
                          <p className='ml-3 text-sm font-semibold '>{koi.name}</p>     
                          <p className='ml-3 text-sm font-semibold '>{koi.age} years</p>
                          <p className='ml-3 text-sm font-semibold '>{koi.variety}</p>
                          <p className='ml-3 text-sm font-semibold '>{koi.length}  cm</p>                       
                        </div>    
                      </div>  
                  </div>
                  {/* <div className='fixed w-[145px] h-14 bottom-6 right-5 rounded-3xl bg-red-500'>
