...
function Dashboard() {
  ...
  const getPayments = async () => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apipayment/user/${userId}`, {
        headers: {
  ...
  const getReport = async () => {
    try {
      ...
      for (const date of surroundingDates) {
        const res = await axios.get('https://koicaresystemv2.azurewebsites.net/apireports/FishPondWater', {
          headers: {
            Authorization: `Bearer ${token}`
          },
          params: {
  ...
  const getOrders = async (orderId) => {
    try {
      ...
      const res = await axios.get(`https://koicaresystemv2.azurewebsites.net/apiorders/${orderId}/order`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
