...
function WaterParameters() {
  ...
  const updateParameter = async (data, waterId) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://koicaresystem.azurewebsites.net/api/water-parameters/update/${waterId}`,
        {
          koiPondId: data.pondId,
          createDateTime: data.createDateTime,
          nitrite: data.nitrite,
  ...
  const deleteParameter = async (waterId)  =>{
    ...
    try {
      ...
      await axios.delete(`https://koicaresystem.azurewebsites.net/api/water-parameters/delete/${waterId}`,{
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
  ...
  const sortParameter = (name, sort) => {
    ...
    if (sort === 'pondName') {
      sortedArray.sort((a, b) => 
        name === 'asc'
          ? a.koiPondName.localeCompare(b.koiPondName)
          : b.koiPondName.localeCompare(a.koiPondName)
      );
    }
          ...
          <div className='text-lg'>
            ...
            <div className='grid grid-cols-4 w-full'>
              <h3
                className='text-base col-span-2'
                style={{
                  color: parameter.carbonHardness >= 4 ? 'green' : parameter.carbonHardness >= 1 ? 'orange' : 'red',
                }}
              >
            ...
            <div className='grid grid-cols-4 w-full'>
              ...
              <h3
                className='text-base col-span-2'
                style={{
                  color: parameter.totalChlorine <= 0.001 ? 'green' : parameter.totalChlorine <= 0.02 ? 'orange' : 'red',
                }}
              >
          ...
          >
            <form onSubmit={handleSubmit(createParameter)} noValidate>
              ...
              <div className='relative col-span-1 mb-2'>
                ...
                <div className='relative col-span-1 mb-2 '>
                  ...
                  {errors.createDateTime && ( 
                      <p className='absolute -bottom-[14px] left-3 text-red-500 text-sm'>{errors.createDateTime.message}</p>
                    )}
                </div>
                ...
                <InfoBox
                    ...
                    content={
                      <>
                        <strong>Optimal Range: 0 - 20 mg/l</strong><br />
                ...
                {errors.nitrate && (
                    <p className='absolute -bottom-[14px] left-3 text-red-500 text-sm'>
                        {errors.nitrate.message}
                    </p>
                )}
                  </div>

                  <div className='relative col-span-1 mb-4'>
                      <label htmlFor='nitrite' className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white'>
                          Nitrite(NO₂):
                      </label>
                      <FaInfoCircle
                          style={{
                     ...
                     <InfoBox
                      ...
                      content={
                        <>
                          <strong>Optimal Range: 0 - 0.1 mg/l</strong><br />
                          The nitrite value can only be kept low by a sufficiently large biofilter and a high circulation rate of the pond water volume (0.5 - 1.0 times per hour) via the filter.<br />
                          If the value is very high in the short term, the pond can be salinated to a salt content of 0.3% to reduce the toxicity.
                        </>
                      }
                      ...
                      {errors.nitrite && (
                          <p className='absolute -bottom-[14px] left-3 text-red-500 text-sm'>
                              {errors.nitrite.message}
                          </p>
                      )}
                  </div>

                  <div className='relative col-span-1 mb-2 mt-2'>
                      <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='phosphate'>
                          Phosphate(PO₄):
                      </label>
                      <FaInfoCircle
                          style={{
                      ...
                      <InfoBox
                          ...
                          content={
                            <>
                              <strong>Optimal Range: 0 - 0.035 mg/l</strong><br />
                              The phosphate value can be positively influenced by large water changes. 
                              If the value is very high in the short term, perform several small partial water changes (5% of the water volume daily) and reduce the amount of food.
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                  <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='ammonium'>
                      Ammonium(NH₄):
                  </label>
                  <FaInfoCircle
                      style={{
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                  <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='hardness'>
                      Hardness(GH):
                  </label>
                  <FaInfoCircle
                      style={{
                  ...
                  <InfoBox
                      ...
                      content={
                        <>
                          <strong>Optimal Range: 0 - 21 °dH</strong><br />
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                    <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='oxygen'>
                        Oxygen(O₂):
                    </label>
                    <FaInfoCircle
                        style={{
                    ...
                    <InfoBox
                        ...
                        content={
                          <>
                            <strong>Optimal Range: &gt; 6.5 mg/l</strong><br />
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                    <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='temperature'>
                        Temperature:
                    </label>
                    <FaInfoCircle
                        style={{
                    ...
                    <InfoBox
                        ...
                        content={
                          <>
                            <strong>Optimal Range: 5 - 26 °C</strong><br />
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                    <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='phValue'>
                        pH Value:
                    </label>
                    <FaInfoCircle
                        style={{
                    ...
                    <InfoBox
                        ...
                        content={
                          <>
                            <strong>Optimal Range: 6.9 - 8 </strong><br />
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                    <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='carbonHardness'>
                        Carbon Hardness (KH):
                    </label>
                    <FaInfoCircle
                        style={{
                    ...
                    <InfoBox
                        ...
                        content={
                          <>
                            <strong>Optimal Range: &gt;= 40 °dH</strong><br />
                            To achieve a carbonate hardness (KH) of at least 4 °dH, water changes are necessary. Use tap water for this! Also measure the KH value of the water coming from the tap. If this is also too low, the water must be artificially hardened using calcium carbonate or sodium hydrogen carbonate. The supplement should not be added directly to the biofilter, as this can cause the filter bacteria to die. It is best to add the agent to the water at the pond return.
                          </>
                        }
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                        <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='carbonDioxide'>
                            CO₂:
                        </label>
                        <FaInfoCircle
                            style={{
                        ...
                        <InfoBox
                            ...
                            content={
                              <>
                                <strong>Optimal Range: 5 - 35 mg/l</strong><br />
                                The CO2 concentration in the water depends on both the pH value and the carbonate hardness (KH). Thus, CO2 does not need to be measured and can be calculated automatically by KoiControl. If the pH value and the KH value are good, then this is also true for the CO2 concentration. Moving a lot of CO2 out of the water (e.g. through a strong air supply or a strong water circulation) causes the pH value to increase.
                              </>
                            }
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
                        <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='salt'>
                            Salt:
                        </label>
                        <FaInfoCircle
                            style={{
                        ...
                        <InfoBox
                            ...
                            content={
                              <>
                                <strong>Optimal Range: 0 - 0.1 %</strong><br />
                  ...
                  <div className='relative col-span-1 mb-2 mt-2'>
              <label className='absolute text-md font-medium -top-[8px] left-3 text-red-500 bg-white' htmlFor='totalChlorine'>
                  Total Chlorine:
              </label>
              <FaInfoCircle
                  style={{
              ...
              <InfoBox
                  ...
                  content={
                    <>
                      <strong>Optimal Range: 0 - 0.001 mg/l</strong><br />
            ...
            <InfoBox
                ...
                content={
                  <>
                    <strong>Optimal Range: -40 - 40 °C</strong><br />
            ...
            />
                  <input
                    ...
                    {...register('temp',{required: 'Temp is required' ,
                      min:{
                      value: -100, message: ' Outdoor temp. value cannot below -100 °C'},
                    max: {
                      value: 100, message: 'Outdoor temp. value cannot exceed 100 °C'},
                     })}
                    />
                    {errors.temp &&(
            ...
            />
                  <input
                    ...
                    id='amountFed'
                    className='mt-1 block border border-black outline-none w-full p-3 pr-10 rounded-md shadow-sm'
                    {...register('amountFed',{required: 'Amount Fed is required',
                      min:{
                        value: 0, message: ' Total chlorines value cannot below 0 g'},
                      max: {
                        value: 999999, message: 'Total chlorines value cannot exceed 999999 g'},
                       })}
